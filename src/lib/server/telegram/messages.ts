...
export const sendProcessingStartedMessage = async (orderId: number | string, items: OrderItemDTO[], count: number, sum: number) => {//codes: Map<string, string[]>) => { //order: Order, sum: number, count: number) => {
